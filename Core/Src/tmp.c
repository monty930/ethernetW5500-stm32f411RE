...
Opcode SetInitGateway = { .dword = { 0x30, 0x31, 0x30, 0x30, 192, 168, 0, 255 } }; // 0xC0, 0xA8, 0x00, 0xFF
Opcode SetInitMask = { .dword = { 0x30, 0x31, 0x30, 0x31, 255, 255, 255, 0 } }; // 0xFF, 0xFF, 0xFF, 0x00
Opcode SetInitHWAddress1 = { .dword = { 0x30, 0x31, 0x32, 0x30, 0x00, 0x08, 0xdc, 0x78 } }; // 0x00, 0x08, 0xDC, 0x78
Opcode SetInitHWAddress2 = { .dword = { 0x30, 0x31, 0x33, 0x30, 0x91, 0x71, 0, 0 } }; // 0x91, 0x71, (0x00, 0x00)
Opcode SetInitIp = { .dword = { 0x30, 0x31, 0x30, 0x34, 192, 168, 0, 125 } }; // 0xC0, 0xA8, 0x00, 0x7D
